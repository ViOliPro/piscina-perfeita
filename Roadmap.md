...
- [ x ] Revisão de layout em todas as telas no mobile (formulários grandes, navegação, listas).

### [EM ANDAMENTO] Versão 1.4.4 — Conta e Autenticação
...
- _(ideia agregada)_ Indicador de percentual de divergência/perda por depósito, alimentando o dashboard administrativo.
...
- _(ideia agregada)_ Catálogo de fornecedores com comparação de preços e histórico de preço por produto.
- _(ideia agregada)_ Consumo médio e previsão de reposição com base em séries históricas.
- _(ideia agregada)_ Alertas de produtos próximos do vencimento.
...
- _Observação:_ cobre o lançamento de dados do hidrômetro da Copasa mencionado no backlog — confirmar formato de leitura (manual vs. API da concessionária) quando chegar a vez.

### Versão 1.8.0 — Análises e Qualidade da Água _(nova, a partir das ideias)_
...
### Versão 1.9.0 — Relatórios _(nova, a partir das ideias)_
...
- [ ] Termos de Uso
- [ ] Política de Cookies
- [ ] Aviso de Tratamento de Dados _(opcional, complementar)_
- [ ] Política de Segurança da Informação _(opcional, forte diferencial para clientes empresariais)_
...
### Versão 2.2.0 — Aplicativo Mobile _(a partir das ideias)_
...
### Versão 2.3.0 — Inteligência e Automação de Decisões _(a partir das ideias)_
...
### Versão 2.4.0 — Comunicação com o Cliente _(a partir das ideias)_
...
### Versão 2.5.0 — Empresas de Manutenção _(a partir das ideias)_
...
### Versão 2.6.0 — Financeiro _(a partir das ideias)_
...
### Versão 3.0.0 — Plataforma Completa _(a partir das ideias)_
...
**Segurança** _(complementa a seção 3)_
