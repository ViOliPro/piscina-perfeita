...
namespace PiscinaPerfeita.Api.Migrations
{
    ...
    [Migration("20260823013113_AttMovimentacoesEstoque")]
    partial class AttMovimentacoesEstoque
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PiscinaPerfeita.Api.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("RefreshToken", "piscina-perfeita");
                });
            ...
            modelBuilder.Entity("PiscinaPerfeita.Api.Models.Usuario", b =>
                {
                    ...
                    b.Property<bool>("LoginGoogle")
                        .HasColumnType("boolean")
                        .HasColumnName("logingoogle");
            ...
            modelBuilder.Entity("PiscinaPerfeita.Api.Models.UsuarioLocal", b =>
                {
                    ...
                    b.Property<bool>("EhAdministradorPai")
                        .HasColumnType("boolean")
                        .HasColumnName("ehadministradorpai");
            ...
            modelBuilder.Entity("PiscinaPerfeita.Api.Models.RefreshToken", b =>
                {
                    b.HasOne("PiscinaPerfeita.Api.Models.Usuario", "Usuario")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_refreshtoken_usuarios_usuarioid");
