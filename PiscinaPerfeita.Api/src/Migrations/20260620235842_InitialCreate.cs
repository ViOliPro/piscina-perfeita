...
namespace PiscinaPerfeita.Api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        {
            migrationBuilder.EnsureSchema(name: "piscina-perfeita");

            migrationBuilder
                .AlterDatabase()
                .Annotation(
                    "Npgsql:Enum:piscina-perfeita.tipo_revestimento_enum",
                    "Vinil,Alvenaria,Fibra de vidro,Pastilhas,Porcelanato/Ceramica,Pedras naturais"
                )
                .Annotation(
                    "Npgsql:Enum:piscina-perfeita.tipo_tratamento_enum",
                    "Quimico tradicional,Salinizacao,Ozonio,Luz ultravioleta"
                )
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    createtat = table.Column<DateTimeOffset>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dataanalise = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    datamovimentacao = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                },
        ...
        {
            migrationBuilder.DropTable(name: "Analises", schema: "piscina-perfeita");

            migrationBuilder.DropTable(name: "Estoque", schema: "piscina-perfeita");

            migrationBuilder.DropTable(name: "MovimentacoesEstoque", schema: "piscina-perfeita");

            migrationBuilder.DropTable(name: "Piscinas", schema: "piscina-perfeita");

            migrationBuilder.DropTable(name: "Produtos", schema: "piscina-perfeita");

            migrationBuilder.DropTable(name: "usuarios", schema: "piscina-perfeita");
        }
    }
}
