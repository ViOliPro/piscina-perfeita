...
import { estoqueService, piscinaService, produtoService, usuarioService, depositoService } from "../../config/services.js";
...
// ----------------------------------------------------------
function EstoqueForm({ piscinas, produtos, usuarios, depositos, onSubmit, onCancel, loading }) {
  const [form, setForm] = useState({
    piscinaId: "", produtoId: "", usuarioId: "", depositoId: "", quantidadeAtual: "",
  });
...
export default function Estoque() {
  ...
  return (
    <div>
      ...
      {tab !== "orcamento" && (
        <Toolbar>
          <SearchInput value={search} onChange={setSearch} placeholder="Buscar produto ou depósito…" />
          <FilterSelect
            value={filtroDeposito} onChange={setFiltroDeposito}
