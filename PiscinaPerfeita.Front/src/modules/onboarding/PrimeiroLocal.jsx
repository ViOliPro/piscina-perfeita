  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (ok) window.location.reload();
        ...
        setError(
          "Local criado, mas não foi possível ativá-lo automaticamente. Tente relogar.",
        );
    } catch (err) {
      ...
      <div style={{ width: "100%", maxWidth: 560 }}>
        ...
        <Card>
          ...
          <p style={{ margin: "0 0 20px", fontSize: 13, color: "#5a6b7a" }}>
            Você ainda não tem nenhum condomínio/unidade vinculado. Como
            Administrador, você pode cadastrar quantos locais precisar
            administrar — vamos começar pelo primeiro.
          </p>
