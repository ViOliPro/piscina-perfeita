      ...
      <FormGrid>
        <FormField label="Nome do produto *" fullWidth>
          <input
            required
            type="text"
            placeholder="Ex.: Cloro granulado 65%"
            style={inputStyle}
            value={form.nome}
            onChange={set("nome")}
          />
        ...
        <FormField label="Categoria">
          <input
            type="text"
            list="categorias-produto-sugestoes"
          ...
          <datalist id="categorias-produto-sugestoes">
            {CATEGORIAS_PRODUTO_SUGESTOES.map((c) => (
